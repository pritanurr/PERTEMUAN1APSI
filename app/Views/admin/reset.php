...
<body>
    <div class="register1">
        ...
        <form action="<?= base_url('/superadmin/ganti/' . $user['id_user']); ?>" method="post">
            ...
            <div class="vector-parent">
                ...
                <div class="group-div">
                    ...
                    <label for="exampleInpupassword1" class="form-label">New Password</label>
                ...
                <div class="selamat-datang">Reset Password</div>
                ...
                <div class="vector-group" name="login" value="login" type="submit">
                    ...
                    <div class="login1">
                        <button type="submit" name="login" class="btn btn-primary" value="login" style="background-color: #00116d; border-color: #00116d; height: 30px;">Reset</button>
                    </div>
                </div>
            </div>
        </form>
