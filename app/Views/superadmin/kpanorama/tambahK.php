...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url() ?>/css/tambahK.css" />
...
<body>
    <div class="tambahkategori">
        <div class="samping4">
            ...
            <div class="kminimap4" id="minimap">
            ...
            <div class="kkategori5">
                <button class="button-like">
                    ...
                    <b class="kelola-kategori-panorama-container5">
                        <p class="kelola-kategori-panoram4">Kelola Kategori Panorama</p>
                    </b>
                    <img class="school-1-icon4" alt="" src="<?= base_url() ?>/css/public/school-1@2x.png" />
            </div>
            <div class="krespon4" id="respon">
                <button class="button-like">
                    <script>
                    ...
                    <script>
                        ...
                        if (frameContainer) {
                            frameContainer.addEventListener("click", function(e) {
                                window.location.href = "<?= base_url('superdmin') ?>";
                            });
                        }
                    </script>
        ...
        <div class="form">
            ...
            <form action="/superkpanorama/insert" method="post" enctype="multipart/form-data">
            ...
            <form action="<?= base_url('admin/download') ?>" method="post">
                ...
                <div class="tambah2">
                    <button type="submit" style="margin-left: 350px; ">Download</button>
                    <!-- <p class="kelola-kategori-panorama">Tambah</p> -->
                </div>
            </form>
        </div>
        <div class="form-tambah-kategori">Form Edit Kategori Panorama</div>
    </div>
